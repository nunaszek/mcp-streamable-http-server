        ...
        try:
            ...
            if is_tools_call_request:
                ...
                if isinstance(message.root.params, dict):
                    ...
                    # meta_dict_in_params is now guaranteed to be the actual _meta dictionary within message.root.params
                    ...
                    if (
                        ...
                        if "session_id" not in meta_dict_in_params:
                            ...
                            logger.info(
                                f"tools/call params._meta.session_id already exists (value: '{meta_dict_in_params['session_id']}'). No injection of self.mcp_session_id needed here."
                            )
            ...
            if is_initialization_request:
                ...
                if self.mcp_session_id:
                    ...
                    print(f"request_session_id: {request_session_id}")
